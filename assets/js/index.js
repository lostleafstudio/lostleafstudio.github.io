...
function parsePortfolioPage(portfolioPage, data) {
	...
	// Add src back for images that are not part of the portfolio
	$response.find('img.no-portfolio').each(function() {
		$(this).attr('src', $(this).attr('isrc')).removeAttr('isrc');
	});
	$response.find('img:not(.no-portfolio)').each(function() {
...
function initializeActions() {
	...
	// Removed because it messed up on static generated site
